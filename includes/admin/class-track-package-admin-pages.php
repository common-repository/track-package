 ...
 *
 * @package   Track_Package_Admin_Pages
 * @author    justcodeUA
 * @license   GPL-2.0+
...
class Track_Package_Admin_Pages
{
    ...
    public function enqueue_admin_css_js()
    {
        ...
        // Main Plugin Page
        if ($this->plugin_screen_hook_suffix['track_package'] == $screen->id) {
            /* Admin Styles */
            ...
            wp_register_script($this->plugin_slug . '-admin-script', plugins_url('assets/js/admin.js', __FILE__), array(), $this->plugin_version);
    ...
    public function add_plugin_admin_menu()
    {
         ...
         *
         */
        $this->plugin_screen_hook_suffix['track_package'] = add_menu_page(
            __('Track Package', 'track-package'),
            __('Track Package', 'track-package'),
            'manage_options',
